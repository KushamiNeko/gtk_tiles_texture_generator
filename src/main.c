...
//      control->initPatternControl(mainWindow, container, glArea,
//      shaderProgram);
//}
//
...
static void activate() {
  ...
  //                   (void *)user);
  //
  //  //  initPattern(pattern, GTK_WINDOW(mainWindow),
  //  GTK_CONTAINER(controlerBox),
  //  //              GTK_GL_AREA(mainGL), mainShaderProgram);
  //
...
int main(int argc, char **argv) {
  ...
  //
  //  struct PatternControl **patternCollection = collectPattern(1,
  //  patternAlpha);
