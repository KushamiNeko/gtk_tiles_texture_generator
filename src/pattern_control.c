...
// static void glAreaFlush(struct PatternData *user) {
...
// static void *patternControlOffsetControlChanged(void *userData) {
//  //printf("hello\n");
//  struct ControlData *control = (struct ControlData *)userData;
//  struct PatternData *user = (struct PatternData *)control->patternData;
//
...
//  //  g_thread_new("patternControlOffsetControlChanged",
//  //               patternControlOffsetControlChanged, userData);
//
//  struct ControlData *control = (struct ControlData *)userData;
//  struct PatternData *user = (struct PatternData *)control->patternData;
//
...
//
//  numCpySlider =
//      gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 1.0f, 20.0f,
//      1.00f);
...
//
//  randUVSeedSlider =
//      gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 0.0f, 1.0f,
//      0.001f);
...
//
//  uvScaleSlider =
//      gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 0.0f, 2.0f,
//      0.001f);
...
//
//  colorMaxSlider =
//      gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 1.0f, 2.0f,
//      0.001f);
...
//  gtk_label_set_line_wrap_mode(GTK_LABEL(renderPathInfoLabel),
//  PANGO_WRAP_CHAR);
//
...
//
//  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(renderColorCheckButton),
//  TRUE);
//
...
//      (struct PatternAlpha *)DEFENSE_MALLOC(sizeof(struct PatternAlpha));
